            ...
            if opinions_count:
                ...
                while (url):
                    ...
                    for opinion in opinions:
                        ...
                        if single_opinion["pros"] == []:
                            single_opinion["pros"] = ["Brak"]
                        if single_opinion["cons"] == []:
                            single_opinion["cons"] = ["Brak"]
                        all_opinions.append(single_opinion)
                        if single_opinion["recommendation"] == None:
                            single_opinion["recommendation"] = "Brak"
                    try:
                ...
                stats = {
                    ...
                    'pros_count': int(opinions.pros.apply(lambda p: 1 if p != ["Brak"] else 0).sum()),
                    'cons_count': int(opinions.cons.apply(lambda c: 1 if c != ["Brak"] else 0).sum()),
...
def product(product_id):
    ...
    return render_template("product.html.jinja", product_opinions=product_opinions, product_id=product_id)
